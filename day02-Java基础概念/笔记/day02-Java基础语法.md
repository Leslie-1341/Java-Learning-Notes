...
​	不管在注释当中写什么内容，都不会影响代码运行的结果。

​        不管是多行注释还是单行注释，都不要在注释中嵌套

## 2. 关键字

### 2.1 概念

​	<u>被Java赋予了特定含义的英文单词。</u>

​	当我们在代码中写了关键字之后，程序在运行的时候，就知道要做什么事情了。

关键字特点：<u>字母全部小写</u>，常用代码编辑器针对关键字会进行高亮显示。
...
<u>类：Java项目最基本的组成单元</u>，一个完整的Java项目有可能会有成千上万个类来组成的。
...
| 字符           | <u>必须使用单引号，有且仅能一个字符</u>   | ‘A’，‘0’，   ‘我’，’，‘             |
| 字符串         | <u>必须使用双引号，内容可有可无</u>       | “HelloWorld”，“黑马程序员”，“ ”，“” |
...
public class ValueDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println("NULL");//空类型NULL不能直接打印，只能用字符串格式输出
    }
}
~~~
...
​	变量是指在程序的执行过程中，其值有可能发生改变的量（数据）

​	变量可以理解为程序中临时存储数据的容器，但是这个容器中只能存一个值。
...
![image-20260322155613698](C:\Users\61924\AppData\Roaming\Typora\typora-user-images\image-20260322155613698.png)
...
![image-20260322153100405](C:\Users\61924\AppData\Roaming\Typora\typora-user-images\image-20260322153100405.png)
