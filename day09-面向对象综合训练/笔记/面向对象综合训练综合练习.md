...
public class Role {
    ...
    //Role r1 = new Role（）；
    //Role r2 = new Role（）；
    //r1.攻击(r2) -> r1调用一个攻击的方法，r2作为传入的参数
    //方法的调用者去攻击参数
    public void attack(Role role) {
        ...
        System.out.println(this.getName() + "举起拳头，打了" + role.getName() + "一下，" +
                "造成了" + hurt + "点伤害，" + role.getName() + "剩下" + remainBoold + "点血");
    }
...
​	长相是提前定义好的，放在一个数组当中，程序运行之后，从数组中随机获取。
...
​	武功招式也是提前定义好的，放在一个数组当中，程序运行之后，从数组随机获取。
...
​	受伤的提前也是提前定义好的，但不是随机的，根据剩余血量获取不同的描述
